...
class ProjectSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Project::create([
            ...
            'description'  => "Reading Space is a social reading platform currently in development. It allows users to track their reading progress, write and share book reviews, create reading lists, and join community reading challenges. Built with Laravel and Livewire for a reactive experience without a heavy JS framework.",
            'stack'        => 'Laravel, Livewire, MySQL, Blade',
            'cover_image'  => null,
            'live_url'     => null,
            'github_url'   => null,
            'is_featured'  => false,
